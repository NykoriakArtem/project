...
class VulnPageLocators:
    ...
    TAG_INPUT_SEARCH_FIELD = (By.XPATH, "//*[@class='ui-select-search input-xs ng-pristine ng-untouched ng-valid']")
    TAG_INPUT_RESULT = (By.XPATH, "//*[@class='ui-select-choices ui-select-choices-content ui-select-dropdown dropdown-menu']")
